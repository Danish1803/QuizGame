...
public class Login extends JFrame implements ActionListener{
    ...
    Login() {
        ...
        image.setBounds(-70, -20, 600, 500);
        add(image);

        JLabel heading = new JLabel("Thinking Caps On!");
        heading.setBounds(600, 60, 1300, 45);
        heading.setFont(new Font("Harlow Solid Italic", Font.BOLD, 40));
